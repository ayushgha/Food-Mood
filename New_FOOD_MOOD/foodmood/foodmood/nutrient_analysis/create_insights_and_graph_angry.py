...
df = pd.read_csv('nutrient_cal_angry1.csv', header=None, names=col)
print(df.head())
...
total = [fat,Carbs,Fiber,Protein,Sodium/4,Calcium,Magnesium,Potassium,Phosphorous,VitaminC,Iron]
sum_total = sum(total)
print(sum_total)
...
plt.title('Nutrient Need in case of Angry emotions')
plt.show()
